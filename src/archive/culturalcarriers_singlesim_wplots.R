...
params <- CJ(
  ...
  b1 = c(0.6), # initial socialization susceptibility
  ...
  r2 = c(0.0), # max increase in turnover probability
  
  # hiring params (no noise)
  select = 0, # selectivity on
  s0 = c(1.0), # base rate of random entry
